        ...
        <div ref={modalRef} onClick={closeModal} id='main' className="fixed inset-0 bg-opacity-30 backdrop-blur-sm flex justify-center items-center">
            <div className='mt-10 flex flex-col text-white'>
                ...
                <div className='bg-purple-900 rounded-xl px-4 py-4 flex-col gap-5 items-center mx-3'>
                    <h1 className='text-2xl font-extrabold'>Republic day sale!</h1><br/>
                    <p className='text-2xl font-bold max-w-md text-center'>Passes for Gitamites are now available at 700/- on January 26th</p><br/>
                    <p className='text-l max-w-md text-center'>Note: The sale does not apply to Non Gitamite passes</p>
